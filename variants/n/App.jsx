  ...
  return (
    <section className="fleet" id="fleet">
      <motion.div
        ...
        variants={stagger}
      >
        <motion.p className="fleet__label" variants={fadeUp}>Our Fleet</motion.p>
    ...
    <section className="features" id="features">
      <div className="features__inner">
        ...
        >
          ...
          <motion.h2 className="features__title" variants={fadeUp} custom={1}>
            ...
            <motion.div key={i} className="reviews__card" variants={fadeUp} custom={i}>
              <div className="reviews__stars">
                {Array.from({ length: t.rating }).map((_, j) => (
                  <Star key={j} size={16} fill="#635bff" stroke="none" />
                ))}
              </div>
