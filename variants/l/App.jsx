    ...
    <section className="hero">
      ...
      <div className="hero__content">
        ...
        >
          ...
          <motion.div className="hero__stats" variants={fadeUp} custom={3}>
            <div>
              <div className="hero__stat-value mono">500+</div>
              <div className="hero__stat-label">Rentals / month</div>
            </div>
            <div>
              <div className="hero__stat-value mono">4.9</div>
              <div className="hero__stat-label">Average rating</div>
            </div>
            <div>
              <div className="hero__stat-value mono">10min</div>
              <div className="hero__stat-label">Airport pickup</div>
            </div>
          </motion.div>
        </motion.div>
  ...
  return (
    <section className="fleet" id="fleet">
      <motion.div
        ...
        variants={stagger}
      >
        <motion.p className="fleet__label" variants={fadeUp}>// fleet</motion.p>
        <motion.h2 variants={fadeUp}>Choose Your Machine</motion.h2>
          ...
          >
            ...
            <div className="fleet__card-body">
              ...
              <div className="fleet__card-footer">
                ...
                <button className="fleet__card-btn">
  ...
  return (
    <section className="features" id="features">
      <motion.div
        ...
        variants={stagger}
      >
        <motion.p className="features__label" variants={fadeUp}>// advantages</motion.p>
            ...
            <motion.div key={i} className="reviews__card" variants={fadeUp} custom={i}>
              <div className="reviews__stars">
                {Array.from({ length: t.rating }).map((_, j) => (
                  <Star key={j} size={16} fill="#22c55e" stroke="none" />
                ))}
              </div>
...
function Footer() {
  return (
    <footer className="footer">
      <div className="neon-line" style={{ marginBottom: '4rem' }} />
